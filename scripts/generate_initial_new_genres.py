...
NEW_GENRES = [
    "amateur_video", "nikkatsu", "subscription", "vr_channel",
    "dvd", "figure", "novel", "photobook",
    "tl", "tl_doujin", "bl_book", "anime_dvd",
]
